import { MdLock, MdFiberManualRecord, MdLocationOn, MdMail } from "react-icons/md";
...
export default function Footer() {
  return (
    <footer className="bg-slate-950 border-t border-white/5 pt-8 md:pt-12 pb-6 md:pb-8 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              {["SaaS Product Engineering", "API & Microservices", "Enterprise Dashboards", "Legacy Modernization"].map((item, i) => (
                <li key={i}>
                  <a className="text-slate-400 hover:text-blue-500 transition-colors text-sm flex items-center group" href="#services">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3">
              {["Methodology", "Case Studies", "Privacy Policy", "Terms of Service"].map((item, i) => (
                <li key={i}>
                  <a className="text-slate-400 hover:text-blue-500 transition-colors text-sm flex items-center group" href={i < 2 ? (i === 0 ? "#process" : "#portfolio") : "#"}>
                    <MdFiberManualRecord className="text-[6px] mr-2 opacity-0 group-hover:opacity-100 transition-all" />
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-center gap-4">
                <MdMail className="text-blue-500 text-xl" />
                <a className="text-slate-400 hover:text-blue-500 transition-colors text-sm" href="mailto:sanjay@developerchowk.com">sanjay@developerchowk.com</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-6 md:pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-6">
            <a className="text-slate-500 hover:text-blue-500 transition-all duration-300" href="https://www.linkedin.com/company/112421408" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>
            </a>
            <a className="text-slate-500 hover:text-blue-500 transition-all duration-300" href="https://github.com/sanjayasd45" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            ...
            <a className="text-slate-500 hover:text-blue-500 transition-all duration-300" href="https://www.instagram.com/thedeveloperchowk" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
      ...
      <div className="absolute bottom-0 right-0 w-[40%] h-[30%] bg-blue-500/5 blur-[100px] pointer-events-none"></div>
    </footer>
  );
}
